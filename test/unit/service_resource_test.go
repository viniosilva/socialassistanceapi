...
// 	cases := map[string]struct {
// 		inputResourceID  int
// 		expectedResource service.ResourcesResponses
// 		expectedErr      error
// 		prepareMock      func(mock *mock.MockResourceStore)
// 	}{
// 		"should return resource when exists": {
// 			inputResourceID:  1,
// 			expectedResource: service.ResourcesResponse{Data: &service.Resource{ID: 1, CreatedAt: DATE, UpdatedAt: DATE, Name: "Test"}},
// 			prepareMock: func(mock *mock.MockResourceStore) {
...
// 			inputResourceID:  1,
// 			expectedResource: service.ResourcesResponse{},
// 			prepareMock: func(mock *mock.MockResourceStore) {
...
// 			expectedResource: service.ResourcesResponse{Data: &service.Resource{ID: 1, CreatedAt: DATE, UpdatedAt: DATE, Name: "Test update"}},
// 			prepareMock: func(mock *mock.MockResourceStore) {
